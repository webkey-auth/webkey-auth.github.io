...
createServer(8100, '/test/localhostDemo.html')
createServer(8101, '/guest.html')



function createServer(port, indexLocation) {
    ...
    //    if(err) throw err
        ...
        server.listen(port)
        console.log("listening on port "+port+" over https")
    //})
}